function [BestCenter,BestDistanceMatrix,Errors,Volumes,Centers,StepSizes,GradientVectors]=FitEllipsoidEnhanced(Samples,Lambda,StepSize,MaxStepSize,MinStepSize,NumSteps)
% Fit an ellipsoid to data, enhanced version
